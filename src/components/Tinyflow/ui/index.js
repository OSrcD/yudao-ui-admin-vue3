...
const m2 = {
  hash: "svelte-1xa0imv",
  code: ".transparent.svelte-1xa0imv {background:transparent;}"
};
function bh(t, e) {
  le(e, !0), Ge(t, m2);
...
var A2 = /* @__PURE__ */ ne('<div aria-live="assertive" aria-atomic="true" class="a11y-live-msg svelte-gygyu3"> </div>'), D2 = /* @__PURE__ */ ne('<div class="a11y-hidden svelte-gygyu3"> </div> <div class="a11y-hidden svelte-gygyu3"> </div> <!>', 1);
const I2 = {
  hash: "svelte-gygyu3",
  code: ".a11y-hidden.svelte-gygyu3 {display:none;}.a11y-live-msg.svelte-gygyu3 {position:absolute;width:1px;height:1px;margin:-1px;border:0;padding:0;overflow:hidden;clip:rect(0px, 0px, 0px, 0px);clip-path:inset(100%);}"
};
function Dh(t, e) {
  le(e, !0), Ge(t, I2);
  let n = v(e, "store", 7);
...
var K2 = /* @__PURE__ */ ne('<div class="svelte-flow__selection svelte-17f97m7"></div>');
const W2 = {
  hash: "svelte-17f97m7",
  code: ".svelte-flow__selection.svelte-17f97m7 {position:absolute;top:0;left:0;}"
};
function Ql(t, e) {
  le(e, !0), Ge(t, W2);
...
const Y2 = {
  hash: "svelte-1v8barv",
  code: `.svelte-flow__selection-wrapper.svelte-1v8barv {position:absolute;top:0;left:0;z-index:2000;pointer-events:all;}.svelte-flow__selection-wrapper.svelte-1v8barv:focus,
  .svelte-flow__selection-wrapper.svelte-1v8barv:focus-visible {outline:none;}`
};
function Bh(t, e) {
  le(e, !0), Ge(t, Y2);
  ...
  }, m = de(), y = J(m);
  {
    var w = (b) => {
      ...
      Ql(x, { width: "100%", height: "100%", x: 0, y: 0 }), W(S), At(S, (_, T) => Ah?.(_, T), () => ({
        ...
        (_) => {
          Yt(S, 1, ur(["svelte-flow__selection-wrapper", n().noPanClass]), "svelte-1v8barv"), Ne(S, "role", n().disableKeyboardA11y ? void 0 : "button"), Ne(S, "tabindex", n().disableKeyboardA11y ? void 0 : -1), E = Pt(S, "", E, _);
        },
        [
          () => ({
            width: Hn(c(l).width),
